...
// Filtra apenas os que têm estoque maior que 0
const produtosEmEstoque = produtos.filter(item => item.estoque > 0);

// Exibe no console
console.log("Produtos disponíveis em estoque:");
console.log(produtosEmEstoque);

// Exibe também na tela para facilitar testes no navegador
document.addEventListener("DOMContentLoaded", () => {
  const saida = document.getElementById("saida");
  saida.textContent = JSON.stringify(produtosEmEstoque, null, 2);
});
